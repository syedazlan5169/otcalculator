...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles -->
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/ot-calculator2.js'])
    </head>
                                    ...
                                    <table class="w-full border-collapse">
                                        <thead>
                                            <tr class="bg-gradient-to-r from-slate-400 to-blue-400">
                                                ...
                                                <th class="px-2 py-3 text-center text-xs font-bold text-white uppercase tracking-wider w-20">Clear</th>
                                            </tr>
                                        </thead>
